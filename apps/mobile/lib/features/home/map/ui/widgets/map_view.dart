      ...
      child: Builder(
        builder: (context) {
          ...
          if (widget.initialCenter != null &&
              vm.center != widget.initialCenter) {
                      ...
                      CircleLayer(
                        circles: [
                          CircleMarker(
                            ...
                            color: kBluePulse.withValues(alpha: 0.15),
                            borderColor: kBluePulse.withValues(alpha: 0.3),
                            borderStrokeWidth: 2,
                          ),
                        ],
                      ),
                      ...
                      markers: [
                        if (userPoint != null)
                          Marker(
                            ...
                            height: 80,
                            point: userPoint,
                            child: const PulsingMarkerWidget(),
                          ),

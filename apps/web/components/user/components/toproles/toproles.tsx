  ...
  return (
    <>
      <div className="max-w-4xl w-full h-20 top-0 flex justify-center space-x-1">
        <div>
          <div className="bg-auth-colors-green w-9 border-3 border-white h-9 rounded-full flex items-center justify-center text-auth-color-bg-white">
            <Check />
          </div>
          <div>
        ...
        <div>
          <div className="bg-auth-colors-green w-9 border-3 border-white h-9 rounded-full text-center text-xl font-semibold text-auth-color-bg-white">
            2
          </div>
          <div>

  ...
  return (
    <div className={styles.auth_container}>
      <div className={styles.auth_card_container}>
        <div className="w-[62%] rounded-tl-sm rounded-bl-sm auth-card-bg-gradient  text-auth-text-light flex items-center xxs:w xxs:h-350s xs:h-350s xs:w xs:w-20 md:w-[55%] sm:w-[50%]">
          <div className="w-full h-3/4 overflow-hidden text-center xxs:p-4 lg:m-18  xs:pt sm:p-4 sm:pt-11 ">
            ...
            <button className="rounded-sm border border-white text-auth-text-light px-25 py-1.5 hover:bg-white hover:text-orange-500 transition-all duration-300 font-medium xxs:hidden xs:hidden">
              Sign up
            </button>
          </div>
        </div>
          ...
          <div className="w-full h-3/2  px-6">
            <Form {...form}>
              ...
              <Button
                ...
                className="w-full h-10 bg-auth-primary rounded-sm text-auth-text-light"
              >
                {loading ? (
                  <span className="flex items-center justify-center">
                    <svg
                      className="animate-spin -ml-1 mr-3 h-5 w-5 text-auth-text-light"
              ...
              <div className="text-center">
                <p className="text-sm text-auth-secondary mb-4 mt-2">— Or continue with —</p>

                <div className="flex justify-center space-x-4">
                  <div className="flex space-x-4">
                    <button className="border border-auth-primary w-10 h-10 bg-white hover:bg-gray-50 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg flex items-center justify-center">
                ...
                <div className="w-full text-left">
                  <p className="text-xs text-auth-secondary mt-6">
                    Pas encore de compte ?{' '}
                    <a
                      href="#"
                      className="font-bold underline text-auth-secondary hover:text-auth-primary"
                    >
                      S'inscrire
                    </a>
                  </p>
    ...
    /*<div className="min-h-screen min-w-[50%] shadow-blue-400 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-linear-to-r from-blue-600 to-indigo-600 p-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-auth-text-light">Bienvenue</h1>
        </div>
            ...
            <div className="space-y-6">
              ...
              <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                <Button
                  ...
                  disabled={loading}
                  onClick={form.handleSubmit(login)}
                  className="w-full h-12 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-auth-text-light font-medium rounded-lg shadow-md transition-all"
                >
                  {loading ? (
                    <span className="flex items-center justify-center">
                      <svg

            ...
            <Tooltip>
              ...
              >
                <div className="w-8 h-8 bg-[#9EDD28] rounded-full flex items-center justify-center">
                  <Icon icon="mdi:user" width="20" height="20" className="text-white cursor-pointer hover:scale-120 transition-transform duration-200" />
                </div>
              </TooltipTrigger>
              <TooltipContent side="right" align="center">
                <p>Profil</p>
        ...
        <Link href="">
          ...
          >
            <Tooltip>
              ...
              >
                <Icon icon="uil:setting" width="30" height="30" className="text-pink-500 cursor-pointer hover:scale-120 transition-transform duration-200" />
              </TooltipTrigger>
              <TooltipContent side="right" align="center">
                <p>Parametre</p>
              </TooltipContent>

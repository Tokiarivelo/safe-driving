  ...
  return (
    <>
      ...
      <div className={styles.auth_toprole9}>
        <div>
          <div className={styles.auth_toprole10}>1</div>
          <div>
            <h3 className={styles.auth_toprole11}> {t('title1')}</h3>
          </div>
        </div>
        ...
        <div>
          <div className={styles.auth_toprole14}>2</div>
          <div>
            <h3 className={styles.auth_toprole15}> {t('title2')}</h3>
          </div>
        </div>
      </div>
    </>
